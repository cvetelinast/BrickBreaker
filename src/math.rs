...
pub fn circle_collides_rect(cx: f32, cy: f32, radius: f32, rx: f32, ry: f32, rw: f32, rh: f32) ->  Collision {
    ...
    // if distance <= radius {
    //     if matches!(horizontal_collision, Collision::None) && !matches!(vertical_collision, Collision::None) {
    //         return vertical_collision;
    //     } else if !matches!(horizontal_collision, Collision::None) && matches!(vertical_collision, Collision::None){
